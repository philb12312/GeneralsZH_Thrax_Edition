...
//-------------------------------------------------------------------------------------------------
/** Forward an in-game chat line to this player's AI, if any. */
//-------------------------------------------------------------------------------------------------
void Player::onChatMessage(const Player *sender, const UnicodeString &text, Int playerMask)
{
	if (m_ai)
	{
		m_ai->onChatMessage(sender, text, playerMask);
	}
}
