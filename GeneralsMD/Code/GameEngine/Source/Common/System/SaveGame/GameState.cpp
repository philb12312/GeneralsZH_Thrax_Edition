...
SaveCode GameState::loadGame( AvailableGameInfo gameInfo )
{
	...
	// Save loading does not run the normal startNewGame() shutdown path, so ensure
	// load-screen-only rendering is disabled once the snapshot has been fully restored.
