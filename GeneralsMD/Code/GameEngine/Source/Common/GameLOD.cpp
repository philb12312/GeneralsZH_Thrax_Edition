...
{
	// Disabled: The dynamic quality reduction system would lower shadows, heat effects,
	// and particles when FPS dipped below 58, causing visual artifacts. Graphics stay
	// at user-configured quality at all times.
}
