...
// ------------------------------------------------------------------------------------------------
/** Default AI players do not react to chat. */
// ------------------------------------------------------------------------------------------------
void AIPlayer::onChatMessage(const Player *sender, const UnicodeString &text, Int playerMask)
{
	(void)sender;
	(void)text;
	(void)playerMask;
...
void AIPlayer::update()
{
	...
	#define AIP_PERF_BEGIN() QueryPerformanceCounter(&_qpcA)
	#define AIP_PERF_END(tag) do { QueryPerformanceCounter(&_qpcB); \
