...
public:
	...
	// Returns the configured FPS value regardless of whether the limiter toggle is on/off.
	int Graphics_GetFPSValue() const { return m_Render_FramerateLimit_FPSVal; }
...
private:
	...
	int m_Render_FramerateLimit_FPSVal = GetDefaultMonitorFps(); // TheSuperHackers @mod Default to monitor refresh rate
