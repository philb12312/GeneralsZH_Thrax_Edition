...
namespace
{
	class ControlBarPerfScope
	{
	public:
		explicit ControlBarPerfScope( const char *tag ) : m_token( PerfBeginScopedLogicSub( tag ) )
		{
		}
...
void W3DLeftHUDDraw( GameWindow *window, WinInstanceData *instData )
{
	...
	else if( rts::localPlayerHasRadar() )
	{
		...
		ControlBarPerfScope perfScope( "Cl_UI_Win_Radar" );
...
void W3DCommandBarBackgroundDraw( GameWindow *window, WinInstanceData *instData )
{
	...
	ControlBarPerfScope perfScope( "Cl_UI_Win_CBBg" );
...
void W3DCommandBarForegroundDraw( GameWindow *window, WinInstanceData *instData )
{
	...
	ControlBarPerfScope perfScope( "Cl_UI_Win_CBFg" );
