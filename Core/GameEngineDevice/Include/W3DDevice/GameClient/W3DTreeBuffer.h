...
private:
	enum { MAX_TREE_VERTEX=65000,
					MAX_TREE_INDEX=65000,
					MAX_TREES=12000};
	enum {MAX_TYPES = 64,
				MAX_TILES = 512,
...
protected:
	...
	Bool ensureTreeBuffer(Int bufferIndex);
	...
	void cull(const CameraClass * camera);						 ///< Updates live tree visibility and sort keys.
