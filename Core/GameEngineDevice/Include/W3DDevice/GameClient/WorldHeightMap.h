...
#endif
	enum {
		// TheSuperHackers @mod Increased draw region to support higher max camera zoom
		NORMAL_DRAW_WIDTH = 1 + 12*VERTEX_BUFFER_TILE_LENGTH,
		NORMAL_DRAW_HEIGHT = 1 + 12*VERTEX_BUFFER_TILE_LENGTH,
		STRETCH_DRAW_WIDTH = 1 + 6*VERTEX_BUFFER_TILE_LENGTH,
		STRETCH_DRAW_HEIGHT = 1 + 6*VERTEX_BUFFER_TILE_LENGTH,
	};
