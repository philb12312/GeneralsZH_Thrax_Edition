...
protected:
	...
	void drawStructureMarkers( Int pixelX, Int pixelY, Int width, Int height, Bool drawResourceStructures );
	void drawStructureList( const RadarObject *listHead, Int pixelX, Int pixelY, Int width, Int height, Bool drawResourceStructures );
	void initializeShroudTexture( Int dataWidth, Int dataHeight );
	void rebuildShroudTexture();
	...
	Int m_shroudDataWidth;										///< logical shroud width in cells
	Int m_shroudDataHeight;									///< logical shroud height in cells
	UnsignedByte *m_shroudCellAlphaBuffer;			///< logical shroud alpha values per cell
	Bool m_shroudTextureDirty;							///< true when high-res shroud texture needs rebuild
