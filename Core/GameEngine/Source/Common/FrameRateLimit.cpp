...
const UnsignedInt RenderFpsPreset::s_fpsValues[] = {
	...
	60, 65, 70, 72, 75, 80, 85, 90, 100, 110, 120, 144, 165, 240, 480, UncappedFpsValue }; // TheSuperHackers @mod Added 165 Hz preset
#else
	30, 50, 56, 60, 65, 70, 72, 75, 80, 85, 90, 100, 110, 120, 144, 165, 240, 480, UncappedFpsValue }; // TheSuperHackers @mod Added 165 Hz preset
#endif
