...
//-------------------------------------------------------------------------------------------------
/** check whether the specified key is currently down in the latest keyboard state */
//-------------------------------------------------------------------------------------------------
Bool Keyboard::isKeyDown( KeyDefType key ) const
{
	...
	return BitIsSet( m_keyStatus[ keyIndex ].state, KEY_STATE_DOWN ) ? TRUE : FALSE;
}
